...
// bazel-out/k8-fastbuild/bin/tests/generated.txt
extern const char _binary_bazel_out_k8_fastbuild_bin_tests_generated_txt_start;
extern const char _binary_bazel_out_k8_fastbuild_bin_tests_generated_txt_end;
...
extern const char _binary_external_bazel_skylib__LICENSE_start;
extern const char _binary_external_bazel_skylib__LICENSE_end;
...
// bazel-out/k8-fastbuild/bin/tests/generated.txt
::absl::string_view tests_generated_txt() {
  static ::absl::string_view ret{&_binary_bazel_out_k8_fastbuild_bin_tests_generated_txt_start,
    ::absl::string_view::size_type(
        &_binary_bazel_out_k8_fastbuild_bin_tests_generated_txt_end -
        &_binary_bazel_out_k8_fastbuild_bin_tests_generated_txt_start)};
  return ret;
}
...
::absl::string_view LICENSE() {
  static ::absl::string_view ret{&_binary_external_bazel_skylib__LICENSE_start,
    ::absl::string_view::size_type(
        &_binary_external_bazel_skylib__LICENSE_end -
        &_binary_external_bazel_skylib__LICENSE_start)};
  return ret;
}
...
EmbeddedIndex EmbedIndex() {
  static std::pair<absl::string_view, absl::string_view> kRet[] = {
    ...
    {"tests/generated.txt", tests_generated_txt()},
...
EmbeddedIndex OriginMap() {
  static std::pair<absl::string_view, absl::string_view> kRet[] = {
    ...
    {"tests/generated.txt", "tests/generated.txt"},
